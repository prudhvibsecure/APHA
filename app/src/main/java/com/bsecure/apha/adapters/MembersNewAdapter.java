...
public class MembersNewAdapter extends RecyclerView.Adapter<MembersNewAdapter.ContactViewHolder> {
    ...
    public MembersNewAdapter(List<Members> list, Context context, ContactAdapterListener listener) {
