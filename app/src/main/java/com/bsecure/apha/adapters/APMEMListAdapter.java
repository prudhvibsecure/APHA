...
public class APMEMListAdapter extends RecyclerView.Adapter<APMEMListAdapter.ContactViewHolder> {
    ...
    public APMEMListAdapter(List<VipModel> list, Context context, ContactAdapterListener listener) {
...
//    }
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int position) {
        ...
        try {
            ...
            if (classMode_lList.getImage().length() == 0) {
