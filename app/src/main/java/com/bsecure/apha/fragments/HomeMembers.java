...
public class HomeMembers extends ParentFragment {
    ...
    public static HomeMembers newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] tabs = {getString(R.string.LIS), getString(R.string.APPR)};
    ...
    private void setupTabLayout(String[] tabs, TabLayout tl_settings) {
        ...
        for (int i = 0, count = tabs.length; i < count; i++) {
            ...
            if (i==0) {
                ...
                textView1.setText(getString(R.string.LIS));
                ...
                textView2.setText(getString(R.string.APPR));
    ...
    private void setupViewPager(ViewPager viewPager) {
        adapter.addFrag(MembersFragment.newInstance(), "");
        adapter.addFrag(ApprovelFragment.newInstance(), "");
